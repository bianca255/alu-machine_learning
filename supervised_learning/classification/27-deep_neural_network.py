#!/usr/bin/env python3
"""Defines a deep neural network with multiclass classification."""
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers):
        ...
        Raises:
            TypeError: If nx is not an integer or layers not a list
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Raises:
            TypeError: If iterations is not int, alpha is not float,
                       or step is not integer
